...
export default function SettingsPage() {
  ...
  const { data: notificationPreferences, isLoading: isLoadingNotifications } =
    useNotificationPreferences(userId)

  const isLoading = isSessionPending || isLoadingNotifications
  ...
  const { control, handleSubmit, reset } =
    useForm<NotificationPreferencesFormData>({
      defaultValues: {
        interviewReminders:
          notificationPreferences?.interviewReminders ?? false,
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ToggleRow
                      ...
                      description={t(
                        "notifications.interviewRemindersDescription"
                      )}
                      checked={field.value}
